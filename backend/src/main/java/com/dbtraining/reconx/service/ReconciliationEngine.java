...
public class ReconciliationEngine {
    ...
    private BigDecimal[] priceQty(TradeType t) {
        ...
        } else if (t instanceof com.dbtraining.reconx.model.FXTrade fx) {
            return new BigDecimal[]{fx.fxRate(), fx.notionalCcy1()};
        } else if (t instanceof com.dbtraining.reconx.model.BondTrade b) {
            return new BigDecimal[]{b.couponRate(), b.faceValue()};
        } else if (t instanceof com.dbtraining.reconx.model.DerivativeTrade d) {
